...
function LightningLib:Window(Win)
	if _omg == "sigma" then
		local ScriptName;
		...
		local function ripple(button, x, y)
			spawn(
				function()
					...
					circle.ZIndex = 1000
					circle.ImageColor3 = LightningLib.Themes[Theme].TitleBar
		...
		Lighthub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		Lighthub.ResetOnSpawn = false
		Lighthub.Parent = game:GetService("CoreGui")

		Main.Name = "Main"
		Main.Parent = Lighthub
		Main.BackgroundColor3 = LightningLib.Themes[Theme].Main
		...
		if OnPc or OnTabletLaptop then
			Main.Position = LightningLib.Elements.WideMenu.MainPosition
			Main.Size = LightningLib.Elements.WideMenu.MainSize
		end

		UICorner.Parent = Main

		UIStroke.Parent = Main
		UIStroke.Color = LightningLib.Themes[Theme].Shadow
		UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border

		TitleBar.Name = "TitleBar"
		TitleBar.Parent = Main
		TitleBar.BackgroundColor3 = LightningLib.Themes[Theme].TitleBar
		TitleBar.BorderColor3 = LightningLib.Themes[Theme].TitleBar
		TitleBar.BorderSizePixel = 0
		TitleBar.Size = UDim2.new(0, 592, 0, 33)

		if OnPc or OnTabletLaptop then
			TitleBar.Size = LightningLib.Elements.WideMenu.TitleBarSize
		end
		...
		BarFixer.BackgroundColor3 = LightningLib.Themes[Theme].TitleBar
		BarFixer.BorderColor3 = LightningLib.Themes[Theme].TitleBar
		...
		Line.BackgroundColor3 = LightningLib.Themes[Theme].TitleLineColor
		Line.BorderColor3 = LightningLib.Themes[Theme].TitleLineColor
		...
		Close.Text = "X"
		Close.TextColor3 = LightningLib.Themes[Theme].CloseMinimize
		Close.TextSize = 18.000
		Close.Visible = false

		if OnPc or OnTabletLaptop then
			Close.Position = LightningLib.Elements.WideMenu.ClosePosition
		end
		...
		Minimize.Text = "-"
		Minimize.TextColor3 = LightningLib.Themes[Theme].CloseMinimize
		Minimize.TextSize = 34.000
		Minimize.Visible = false

		if OnPc or OnTabletLaptop then
			Minimize.Position = LightningLib.Elements.WideMenu.MinimizePosition
		end
		...
		Title.TextColor3 = LightningLib.Themes[Theme].TitleTextColor
		Title.TextSize = 16.000
		Title.TextXAlignment = Enum.TextXAlignment.Left

		if OnPc or OnTabletLaptop then
			Title.Position = LightningLib.Elements.WideMenu.TitlePosition
		end
		...
		if OnPc or OnTabletLaptop then
			Tabs.Size = LightningLib.Elements.WideMenu.TabsSize
			Tabs.Position = LightningLib.Elements.WideMenu.TabPosition
		end
		...
		if OnPc or OnTabletLaptop then
			Pages.Position = LightningLib.Elements.WideMenu.PagesPosition
			Pages.Size = LightningLib.Elements.WideMenu.PagesSize
		end

		Shadow.Name = "Shadow"
		Shadow.Parent = Main
		Shadow.Active = true
		Shadow.BackgroundColor3 = LightningLib.Themes[Theme].Shadow
		Shadow.BackgroundTransparency = 1.000
		Shadow.Position = UDim2.new(0, -15, 0, -12)
		Shadow.Size = UDim2.new(1, 30, 0.983647227, 30)
		Shadow.ZIndex = 0
		Shadow.Image = "rbxassetid://5028857084"
		Shadow.ImageColor3 = LightningLib.Themes[Theme].Shadow
		Shadow.ScaleType = Enum.ScaleType.Slice
		Shadow.SliceCenter = Rect.new(24, 24, 276, 276)

		function LightningLib:ToggleUI()	
			for i, v in pairs(game:GetService("CoreGui"):GetChildren()) do
				if v.Name == "Lighthub" then
				...
				if visibility == true then
					...
					if openbutton ~= nil then
						if openbutton == true then
							...
							OpenFrame.Parent = Lighthub
							OpenFrame.Active = true
							OpenFrame.BackgroundColor3 = LightningLib.Themes[Theme].TitleBar
							...
							Open.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
							Open.Size = UDim2.new(1.0, 0, 0.92, 0)
							Open.Font = Enum.Font.GothamBold
							Open.Text = "Open"
							Open.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
		...
		function Sayfalar:Tab(TabName, PageTitle)
			...
			TabBtnFrame.BackgroundColor3 = LightningLib.Themes[Theme].TabBefore
			TabBtnFrame.BorderColor3 = LightningLib.Themes[Theme].TabBefore
			...
			Selected.BackgroundColor3 = LightningLib.Themes[Theme].Selection
			Selected.BackgroundTransparency = 1
			Selected.BorderColor3 = LightningLib.Themes[Theme].Selection
			...
			TabText.TextColor3 = LightningLib.Themes[Theme].TabTextColor
			...
			if OnPc or OnTabletLaptop then
				Page.Size = LightningLib.Elements.WideMenu.PageSize
				Page.Position = LightningLib.Elements.WideMenu.PagePosition
			end
			...
			PageTitle.TextColor3 = LightningLib.Themes[Theme].PageTitleColor
			PageTitle.TextSize = 25.000
			PageTitle.TextXAlignment = Enum.TextXAlignment.Left

			if OnPc or OnTabletLaptop then
				PageTitle.Size = LightningLib.Elements.WideMenu.SectionSize
			end
			...
			if FirstTab == false then
				...
				TabBtnFrame.BackgroundColor3 = LightningLib.Themes[Theme].TabAfter
				TabBtnFrame.BorderColor3 = LightningLib.Themes[Theme].TabAfter
				Page.Visible = true
			end
			...
			TabText.MouseButton1Click:Connect(function()
				...
				for i, v in pairs(Tabs:GetChildren()) do
					if v:IsA("Frame") then
						TweenService:Create(v, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = LightningLib.Themes[Theme].TabBefore}):Play()
						TweenService:Create(v.Selected, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
					end
				end
				TweenService:Create(TabBtnFrame, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = LightningLib.Themes[Theme].TabAfter}):Play()
			...
			function ContainerItems:Section(Title)
				...
				if x ~= nil then
					...
					if OnPc or OnTabletLaptop then
						Section.Size = LightningLib.Elements.WideMenu.SectionSize
					end
					...
					Sektion.TextColor3 = LightningLib.Themes[Theme].PageTitleColor
					Sektion.TextSize = 20
					...
					function SectionItems:Label(title, description)
						...
						Label.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Label.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						LabelListing.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						LabelListing.BackgroundTransparency = 1.000
						LabelListing.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						LabelMainText.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						LabelText.TextColor3 = LightningLib.Themes[Theme].ItemTextColors
					...
					function SectionItems:Button(yazi, description, callback)
						...
						Button.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Button.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ButtonTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						ButtonText.TextColor3 = LightningLib.Themes[Theme].ItemTextColors
						...
						ClickIcon.ImageColor3 = LightningLib.Themes[Theme].ButtonClickIconColor
						...
						Button.MouseEnter:Connect(
							function()
								TweenService:Create(
									Button,
									TweenInfo.new(.2, Enum.EasingStyle.Quad),
									{BackgroundColor3 = LightningLib.Themes[Theme].ButtonHover}
								):Play()
							end
						)
						Button.MouseLeave:Connect(
							function()
								TweenService:Create(
									Button,
									TweenInfo.new(.2, Enum.EasingStyle.Quad),
									{BackgroundColor3 = LightningLib.Themes[Theme].ItemColors}
								):Play()
							end
						)
					...
					function SectionItems:Paragraph(pharagraphtitle, description)
						...
						Pharagraph.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Pharagraph.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						PharagraphTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						for i, v in pairs(desc) do
							...
							PharagraphText.TextColor3 = LightningLib.Themes[Theme].ItemTextColors
					...
					function SectionItems:Slider(Text, minvalue, maxvalue, callback)
						...
						Slider.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Slider.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						SliderTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						SliderButtonFrame.BackgroundColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						SliderButtonFrame.BorderColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						...
						SliderButton.BackgroundColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						SliderButton.BackgroundTransparency = 1.000
						SliderButton.BorderColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						...
						SliderFixer.BackgroundColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						SliderFixer.BackgroundTransparency = 1.000
						SliderFixer.BorderColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						SliderFixer.BorderSizePixel = 0
						SliderFixer.Size = UDim2.new(1, 0, 1, 0)
						SliderFixer.ScrollBarImageColor3 = LightningLib.Themes[Theme].SliderButtonFrameColor
						...
						UIGradient.Color = LightningLib.Themes[Theme].InSliderFrame
						...
						Num.TextColor3 = LightningLib.Themes[Theme].NumColor
						Num.TextSize = 14.000
					...
					function SectionItems:Line()
						...
						Line.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
					...
					function SectionItems:ColorPicker(text, preset, callback)
						...
						Colorpicker.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						...
						Title.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						ColorpickerFrame.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						...
						Confirm.BackgroundColor3 = LightningLib.Themes[Theme].TitleBar
						...
						Confirm.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						RainbowToggle.BackgroundColor3 = LightningLib.Themes[Theme].TitleBar
						...
						RainbowTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						RainbowToggleFrame.BackgroundColor3 = LightningLib.Themes[Theme].Main
					...
					function SectionItems:KeyBind(keytext, first, callback)
						...
						KeyBind.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						KeyBind.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						KeyBindTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						KeyBindTitle.TextSize = 15.000
						KeyBindTitle.TextXAlignment = Enum.TextXAlignment.Left

						BindSelection.Name = "BindSelection"
						BindSelection.Parent = KeyBind
						BindSelection.BackgroundColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						BindSelection.BorderColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						...
						UIStroke_9.Color = LightningLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
						...
						Bind.Text = first
						Bind.TextColor3 = LightningLib.Themes[Theme].ItemKeyBindTextColor
					...
					function SectionItems:Toggle(TexT, check, callback)
						...
						ToggleFrame.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ToggleFrame.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						ToggleFrame.Position = UDim2.new(0.0196850393, 0, 0.637992859, 0)
						ToggleFrame.Size = UDim2.new(0, 391, 0, 44)

						Toggle.Name = "Toggle"
						Toggle.Parent = ToggleFrame
						Toggle.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Toggle.BackgroundTransparency = 1.000
						Toggle.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ToggleText.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ToggleText.BackgroundTransparency = 1.000
						ToggleText.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						ToggleText.Position = UDim2.new(0.031, 0,0.275, 0)
						ToggleText.Size = UDim2.new(0, 121, 0, 22)
						ToggleText.Font = Enum.Font.GothamBold
						ToggleText.Text = TexT
						ToggleText.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						...
						ToggleIconer.BackgroundColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						ToggleIconer.BorderColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						...
						UIStroke.Color = LightningLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
						UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border

						done.Name = "done"
						done.Parent = ToggleIconer
						done.BackgroundColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						done.BorderColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						...
						done.ImageColor3 = LightningLib.Themes[Theme].ToggleTickColor
					...
					function SectionItems:TextBox(TexT, Desc, callback)
						...
						TextBox.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						TextBox.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						TexttingBox.BackgroundColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						TexttingBox.BorderColor3 = LightningLib.Themes[Theme].ItemTextBoxKeyBindColors
						...
						TexttingBox.PlaceholderColor3 = LightningLib.Themes[Theme].ItemTextBoxTextColor
						TexttingBox.PlaceholderText = Desc
						TexttingBox.Text = ""
						TexttingBox.TextColor3 = LightningLib.Themes[Theme].ItemTextBoxTextColor
						...
						UIStroke_4.Color = LightningLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
						UIStroke_4.ApplyStrokeMode = Enum.ApplyStrokeMode.Border

						TextBoxTitle.Name = "TextBoxTitle"
						TextBoxTitle.Parent = TextBox
						TextBoxTitle.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						TextBoxTitle.BackgroundTransparency = 1.000
						TextBoxTitle.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						TextBoxTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
					...
					function SectionItems:Dropdown(teks, list, callback)
						...
						Dropdown.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						...
						Title.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Title.BackgroundTransparency = 1.000
						...
						Arrow.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Arrow.BackgroundTransparency = 1.000
						Arrow.Position = UDim2.new(0.913561523, 0, 0.211111104, 0)
						Arrow.Size = UDim2.new(0, 26, 0, 27)
						Arrow.Image = "rbxassetid://6034818372"
						Arrow.ImageColor3 = LightningLib.Themes[Theme].ItemTitleColors

						DropdownFrame.Name = "DropdownFrame"
						DropdownFrame.Parent = Container
						DropdownFrame.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						...
						DropdownHolder.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						...
						DropdownHolder.ScrollBarImageColor3 = LightningLib.Themes[Theme].TitleBar
						...
						for i, v in next, list do
							...
							Item.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
							Item.BackgroundTransparency = 0.2
							Item.Position = UDim2.new(0, 0, 0.0808080807, 0)
							Item.Size = UDim2.new(0, 371, 0, 24)
							Item.AutoButtonColor = false
							Item.Font = Enum.Font.Gotham
							Item.TextColor3 = LightningLib.Themes[Theme].ItemTextColors
					...
					function SectionItems:Image(title, writeinto, Expander)
						...
						Image.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						Image.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ImageTitle.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ImageTitle.BackgroundTransparency = 1.000
						ImageTitle.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ImageTitle.TextColor3 = LightningLib.Themes[Theme].ItemTitleColors
						ImageTitle.TextSize = 15.000
						ImageTitle.TextXAlignment = Enum.TextXAlignment.Left

						ImageButton.Name = "ImageButton"
						ImageButton.Parent = Image
						ImageButton.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ImageButton.BackgroundTransparency = 1.000
						ImageButton.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ImageFrame.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ImageFrame.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						if string.find(imagelink, "rbxassetid") then
							...
							ImageLabel.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
							ImageLabel.BackgroundTransparency = 1.000
							ImageLabel.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						elseif string.find(imagelink, "https") then			
							...
							VideoLabel.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
							VideoLabel.BackgroundTransparency = 1.000
							VideoLabel.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ImageListing.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ImageListing.BackgroundTransparency = 1.000
						ImageListing.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						...
						ButtonTitle.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
						ButtonTitle.BackgroundTransparency = 1.000
						ButtonTitle.BorderColor3 = LightningLib.Themes[Theme].ItemColors
						ButtonTitle.BorderSizePixel = 0
						ButtonTitle.Size = UDim2.new(0, 379, 0, 17)
						ButtonTitle.Font = Enum.Font.GothamBold
						...
						for i, v in next, description do
							...
							ButtonText.BackgroundColor3 = LightningLib.Themes[Theme].ItemColors
							ButtonText.BackgroundTransparency = 1.000
							ButtonText.BorderColor3 = LightningLib.Themes[Theme].ItemColors
							ButtonText.BorderSizePixel = 0
							ButtonText.Position = UDim2.new(0, 0, 0.170000002, 0)
							ButtonText.Size = UDim2.new(0, 379, 0, 17)
							ButtonText.Font = Enum.Font.Gotham
...
function LightningLib:AddNotifications()
	if _Lighthub == "protection" then
		...
		local LighthubNotifications = Lighthub

		NotifyListing.Name = "NotifyListing"
		NotifyListing.Parent = LighthubNotifications
		...
		NotificationListing.Parent = LighthubNotifications
		...
		function NotificationItems:Notification(Title, Text, Selector, Cooldowm)
			...
			notification.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			notification.BackgroundTransparency = 1.000
			notification.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			notificationcontainer.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			notificationcontainer.BackgroundTransparency = 0.200
			notificationcontainer.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			Listing_2.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Listing_2.BackgroundTransparency = 1.000
			Listing_2.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			LabelMainText_2.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelMainText_2.BackgroundTransparency = 1.000
			LabelMainText_2.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			LabelMainText_2.TextColor3 = LightningLib.Themes[theme].NotificationNotifyTitleColor
			...
			LabelText_2.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelText_2.BackgroundTransparency = 1.000
			LabelText_2.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			LabelText_2.TextColor3 = LightningLib.Themes[theme].NotificationNotifyTextColor
			LabelText_2.TextSize = 15.000
			LabelText_2.TextStrokeColor3 = LightningLib.Themes[theme].NotificationNotifyTextColor
			...
			Shadow_2.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			Shadow_2.ImageColor3 = LightningLib.Themes[theme].IconShadow
			Shadow_2.ScaleType = Enum.ScaleType.Slice
			Shadow_2.SliceCenter = Rect.new(24, 24, 276, 276)

			Icon_2.Name = "Icon"
			Icon_2.Parent = IconFrame_2
			Icon_2.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Icon_2.BackgroundTransparency = 1.000
			Icon_2.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			Icon_2.ImageColor3 = LightningLib.Themes[theme].IconColor			

			UIStroke_2.Parent = notificationcontainer
			UIStroke_2.Color = LightningLib.Themes[theme].NotifyButtons
		...
		function NotificationItems:Notify(title, text, Selector, callback)			
			...
			notify.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			notify.BackgroundTransparency = 1.000
			notify.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			notifycontainer.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			notifycontainer.BackgroundTransparency = 0.200
			notifycontainer.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			Listing.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Listing.BackgroundTransparency = 1.000
			Listing.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			...
			LabelMainText.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelMainText.BackgroundTransparency = 1.000
			LabelMainText.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelMainText.BorderSizePixel = 0
			LabelMainText.Position = UDim2.new(-0.161290318, 0, 0.4375, 0)
			LabelMainText.Size = UDim2.new(0, 232, 0, 17)
			LabelMainText.Font = Enum.Font.GothamBold
			LabelMainText.Text = title
			LabelMainText.TextColor3 = LightningLib.Themes[theme].NotificationNotifyTitleColor
			LabelMainText.TextSize = 15.000
			LabelMainText.TextXAlignment = Enum.TextXAlignment.Left

			LabelText.Name = "LabelText"
			LabelText.Parent = Listing
			LabelText.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelText.BackgroundTransparency = 1.000
			LabelText.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			LabelText.BorderSizePixel = 0
			LabelText.Position = UDim2.new(-0.0497237556, 0, -1.7428571, 0)
			LabelText.Size = UDim2.new(0, 162, 0, 17)
			LabelText.Font = Enum.Font.Gotham
			LabelText.Text = text
			LabelText.TextColor3 = LightningLib.Themes[theme].NotificationNotifyTextColor
			LabelText.TextSize = 15.000
			LabelText.TextXAlignment = Enum.TextXAlignment.Left
			...
			Shadow.Active = true
			Shadow.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Shadow.BackgroundTransparency = 1.000
			Shadow.Position = UDim2.new(0, -15, 0, -15)
			Shadow.Size = UDim2.new(1, 30, 1, 30)
			Shadow.ZIndex = 0
			Shadow.Image = "rbxassetid://5028857084"
			Shadow.ImageColor3 = LightningLib.Themes[theme].IconShadow
			Shadow.ScaleType = Enum.ScaleType.Slice
			Shadow.SliceCenter = Rect.new(24, 24, 276, 276)

			Icon.Name = "Icon"
			Icon.Parent = IconFrame
			Icon.BackgroundColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Icon.BackgroundTransparency = 1.000
			Icon.BorderColor3 = LightningLib.Themes[theme].NotificationNotifyColor
			Icon.Position = UDim2.new(0.159283891, 0, 0.179691225, 0)
			Icon.Size = UDim2.new(0, 26, 0, 26)
			Icon.Image = "http://www.roblox.com/asset/?id=7021995683"
			Icon.ImageColor3 = LightningLib.Themes[theme].IconColor

			UIStroke.Parent = notifycontainer
			UIStroke.Color = LightningLib.Themes[theme].NotifyButtons
			UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
			...
			clear.ImageColor3 = LightningLib.Themes[theme].NotifyButtons
			...
			done.ImageColor3 = LightningLib.Themes[theme].NotifyButtons
			done.ImageRectOffset = Vector2.new(644, 204)
			done.ImageRectSize = Vector2.new(36, 36)
